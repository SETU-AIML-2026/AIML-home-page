...
By **September 4th** at the latest, upload ALL required **funding eligibility** documents on the Springboard portal. This [is the springboard portal site to use for this ](https://springboardcourses.ie/), and the features you need will be available on the SB portal from when you accepted your offer. In respect of a payslip or returner declaration, these must be ***dated*** only within 6 weeks of course start i.e. from July 27th and uploaded to the portal then. For applicants who have already uploaded some of these documents, please complete the remainder now.  Payments from DSP to be dated from August 24.  **All** applicants must upload a redacted payslip OR employer letter dated from July 27th to validate *current* employment status to complete enrolment. 

## 3. When & how do I pay the fees?

For Springboard Students, a fee of €525 must be paid as a once-off up front payment. This represents 10% of the course fee, the remainder is paid by Springboard.

SETU Finance will be in contact with you in due course to arrange payment.

Please note ‘returner’ applicants are exempt from the fee payment. If you have queries please contact Joan at [joan.mangan@setu.ie](mailto:joan.mangan@setu.ie) 

## 4. I have accepted the offer, what happens next?

By September 4th, please also do the following:

- Sign up and in to our Slack organisation (Q.6)
- Sign up for a Github account (Q.7)


When all funding eligibility documents are validated on the Springboard portal you will receive the SETU registration instructions. Please upload all funding eligibility documents now.  All payslips and signed Returner letters will need to be dated **from August 24th**.  Only for those in receipt of DSP payments, the payment verification (payment slip) must be dated **from August 2th**
...
## 9. Do I have to attend Induction?
...
## 10. What should I have done in advance of attending the Induction?
...
All course material will be published on [this site](https://tutors.dev/course/setu-cert-ai-ml-2026). Please bookmark this now.
...
Yes, you can find it [here](https://tutors.dev/course/wit-cert-comp-sci-2026-sem-1-calendar).
...
- [Web Development I](https://tutors.dev/course/setu-cert-comp-sci-2026-web-dev-1)
- [Programming](https://tutors.dev/topic/python-gen/topic-00-induction)

Please complete these labs above in advance of Induction.
...
## 18. What will we do at Induction?
